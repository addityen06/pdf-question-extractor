...
import logging
import re
from pdfextract.core.models import ParagraphBlock, BlockType
from pdfextract.core.constants import ADMIN_KEYWORDS, ADMIN_PATTERNS, MAX_MARKS_PATTERNS, QUESTION_PATTERNS
